...
class Rescuer(AbstAgent):
    def __init__(self, env, config_file, id, classification, estimativa_grav):
        """ 
        ...
        self.estimativa_grav = estimativa_grav
    ...
    def __planner(self):
        ...
        #     victims_data[value[0]] = [value[1][0] + value[1][3:]] 
        # for step in path:
        #     pos_x += step[0]
        #     pos_y += step[1]
        #     dif += self.map[(pos_x,pos_y)][0]
        #     if (pos_x,pos_y) in victims_data:
        #         order += 1
        #         victim = victims_data[(pos_x, pos_y)]
        #         distancia = self.distancia_euclidiana((0,0),(pos_x, pos_y))
        #         priori_data = [dif, victim[4], distancia, order]
        #         self.estimate_priority(priori_data)
        #         priorizacao_data.append([dif, victim[4], distancia, order, victim[0]])
    ...
    def distancia_euclidiana(ponto1, ponto2):
        ...
        :param ponto1: Tuple contendo as coordenadas (x, y) do primeiro ponto
        :param ponto2: Tuple contendo as coordenadas (x, y) do segundo ponto
    ...
    def add_victim(self, victim: dict):
        ...
        for value in self.victim:
            ...
            grav = self.estimativa_grav([value[1][3], value[1][4], value[1][5]])
            value[1].append(grav)
